    ...
    <div class="layout-container">
        ...
        <?php include_once('includes/navbar.php'); ?>
            <div class="content-wrapper">
                ...
                $note_id    = $_GET['page_id'];
                $count      = $_GET['count'];

                if (!isset($project_id) or !isset($note_id) or !isset($count)) {
                ...
                $note_query    = $db->query("SELECT * FROM notes_project WHERE id = '$note_id' ");
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="d-flex justify-content-between align-items-center py-3 mb-4">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Notes / <?php echo $project_name; ?> /</span> Editor</h4>
                    ...
                    <?php include_once('notes-project-recommendations.php');?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 editor d-none">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- Add this inside the editor section, near the form -->
                                <div class="mb-3">
...
<script>
  ...
  $.ajax({
    url: 'notes-save-project-note.php',
    type: 'POST',
    data: {
