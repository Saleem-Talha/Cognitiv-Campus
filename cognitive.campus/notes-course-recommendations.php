...
function fetchCourseRecommendations($db, $noteId) {
    ...
    // Updated query to fetch recommendations by note_id
    $note_recommendations_query = $db->query("SELECT nr.* 
        FROM notes_recommendations nr
        WHERE nr.note_id = '$safeNoteIdParam'
...
<div class="my-3">
    <button type="button" class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#noteRecommendationsModal">
        View Note Recommendations
    </button>
</div>

<!-- Note Recommendations Modal -->
<div class="modal fade" id="noteRecommendationsModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Recommended Courses for Note: <?php echo htmlspecialchars($note_title); ?></h5>
            ...
            <div class="modal-body">
                ...
                <?php else: ?>
                    <div class="text-center p-5">
                        ...
                        <p class="text-muted">We couldn't find any courses related to this specific note.</p>
                    </div>
                <?php endif; ?>
            </div>
