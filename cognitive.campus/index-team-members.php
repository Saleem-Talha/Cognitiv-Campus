<section class="team-section py-5" id="our-team">
    <div class="container">
        <div class="text-center mb-5">
        <span class="label px-3 rounded-2 p-2">Team Member</span>
            <h2 class="mt-3 heading-title">Meet Our Team Members</h2>
            <p class="text-muted">We are a team of skilled developers and designers passionate about creating the best software solutions.</p>
        </div>
        
        <div class="row justify-content-center">
            <div class="col-lg-3 col-md-6 mb-4 team-member">
                <div class="card border h-100">
                    <div style="height: 300px; overflow: hidden;">
                        <img src="img/Logo/talha.jpeg" class="card-img-top" alt="Team Member" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4 team-member">
                <div class="card border h-100">
                    <div style="height: 300px; overflow: hidden;">
                        <img src="img/Logo/anila.jpeg" class="card-img-top" alt="Team Member" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div class="card-body text-center">
            ...
            <div class="col-lg-3 col-md-6 mb-4 team-member">
                <div class="card border h-100">
                    <div style="height: 300px; overflow: hidden;">
                        <img src="img/Logo/saad.jpg" class="card-img-top" alt="Team Member" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div class="card-body text-center">
