...
if (isset($_POST['otp'])) {
    ...
    if (!$rateLimit['allowed']) {
        ...
        $stmt = $db->prepare("SELECT reset_otp, reset_token_expiry FROM users WHERE email = ? AND reset_token = ?");
        ...
        if ($result->num_rows > 0) {
            ...
            $error = "Invalid reset attempt. Please try again.";
        }
    }
}
?>
...
<head>
    ...
    <title>Verify OTP - Cognitive Campus</title>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                submitBtn.innerHTML = '<div class="d-flex justify-content-center align-items-center"><span class="spinner-border spinner-border-sm me-2"></span>Verifying...</div>';
