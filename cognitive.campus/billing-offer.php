...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['plan']) && isset($_POST['offer_id'])) {
    ...
    try {
        $checkout_session = \Stripe\Checkout\Session::create([
            ...
            'metadata' => $metadata,
            'success_url' => 'https://cognitive.aixboost.com//billing-offer-success.php?plan=' . $new_plan . '&email=' . urlencode($userEmail) . '&offer_id=' . $offer_id,
            'cancel_url' => 'https://cognitive.aixboost.com//offer-billing.php?status=cancelled',
        ]);
